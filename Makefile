...
all: SPH_2D SPH_2D_Half

SPH_2D: $(BIN_DIR)/SPH_2D

SPH_2D_Half: $(BIN_DIR)/SPH_2D_Half

$(BIN_DIR)/SPH_2D: $(BUILD_DIR)/SPH_2D.o $(BUILD_DIR)/SPH_Snippet.o $(BUILD_DIR)/file_writer.o
	$(CXX) -o $@ $^ $(CXXFLAGS)

$(BIN_DIR)/SPH_2D_Half: $(BUILD_DIR)/SPH_2D_Half.o $(BUILD_DIR)/SPH_Snippet_Half.o $(BUILD_DIR)/file_writer_Half.o
	$(CXX) -o $@ $^ $(CXXFLAGS)
...
TESTS = test_SPH_2D test_file_writer test_SPH_2D_Half
...
test_SPH_2D_Half: $(TEST_BIN_DIR)/test_SPH_2D_Half
...
$(TEST_BIN_DIR)/test_SPH_2D_Half: $(TEST_BUILD_DIR)/test_SPH_2D_Half.o $(BUILD_DIR)/SPH_2D_Half.o $(BUILD_DIR)/file_writer_Half.o
	$(CXX) -o $@ $^ $(CXXFLAGS) $(CPPFLAGS) $(LDFLAGS)
